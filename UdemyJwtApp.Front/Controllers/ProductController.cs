    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Remove(int id)
        {
            ...
            if (token != null)
            {
                ...
                await client.DeleteAsync($"http://localhost:5289/api/products/{id}");
            }
        ...
        public async Task<IActionResult> Create(CreateProductModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (token != null)
                {
                    ...
                    var response = await client.PostAsync($"http://localhost:5289/api/products", content);
        ...
        public async Task<IActionResult> Update(int id)
        {
            ...
            if (token != null)
            {
                ...
                var responseProduct = await client.GetAsync($"http://localhost:5289/api/products/{id}");
                ...
                if (responseProduct.IsSuccessStatusCode)
                {
                    ...
                    var responseCategory = await client.GetAsync($"http://localhost:5289/api/categories");
